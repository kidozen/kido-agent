...
module.exports = function ({ proxy= null,
    credentials: { marketplace= "", user: username, password: password}}, cb) {

    var hosting = marketplace.replace(/^https?:\/\//i, "");
    ...
    request(reqOptions, function (err, res, body) {
        ...
        try {
            ...
            return cb(Error.create(err.message, { body }, err));
        }
        ...
        request(postRequest, function (err, res, body) {
            ...
            if (!assertion) return cb(Error.create("unable to parse auth token.", { body }));
            ...
            request(postRequest, function (err, res, body) {
                ...
                try {
                    ...
                    return cb(Error.create("an error occured trying to parse the auth token.", { body }, error));
                }
