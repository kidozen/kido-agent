...
var mockNpm = {
    ...
    commands: {
        ...
        show: function(args, cb) { 
            //var err = (args[0]==="mockConnector") ? null : new Error("NPM MOCK: Link failed.");
            setTimeout(function(){ cb(null, ["0.0.1"]); }, 20); // simulates async behavior
        }
    }
};
    ...
    describe ("start", function() {
        ...
        describe("then should process events", function() {
            ...
            describe ("on 'addService'", function () {
                ...
                it.skip ("should install connector, start the service and emit 'serviceReady' event.", function (done) {
                ...
                it.skip ("on two events for different services, should install two services sequentially.", function (done) {
